...
### Install 
Install this library by simply running the following command:
...
## Examples
Here I provide an example codes to use this library in the KITTI ourdoor foreground point cloud segmentation task, and you could refer to the paper [PointRCNN](https://arxiv.org/abs/1812.04244) for the details of task description and foreground label generation.
...
2. Run the following command to train and evaluation:
```shell
cd tools
...
## Acknowledgement
* [charlesq34/pointnet2](https://github.com/charlesq34/pointnet2): Paper author and official code release.
